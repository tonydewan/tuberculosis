...
@interface tuberculosisObject : KrollCoverageObject {
#else
@interface tuberculosisObject : KrollObject {
#endif
@private
...
extern NSString * tuberculosis$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	tuberculosisObject *_tuberculosis;
	BOOL shutdown;
