 ...
 * Copyright (c) 2009-2011 by tuberculosis, Inc. All Rights Reserved.
...
//@interface tuberculosisObject : NSObject
//@end

@interface tuberculosisObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[tuberculosisObject class]])
		{
			for (NSString *key in [[(tuberculosisObject*)o modules] allKeys])
			{
