...
// in simulator we redefine to format for tuberculosis Developer console
...
{\
	NSString * exceptionName = [@"org.tuberculosis." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tuberculosis";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UItuberculosisNativeItemNone = -1, 
	UItuberculosisNativeItemSpinner = -2,
	UItuberculosisNativeItemProgressBar = -3,
	
	UItuberculosisNativeItemSlider = -4,
	UItuberculosisNativeItemSwitch = -5,
	UItuberculosisNativeItemMultiButton = -6,
	UItuberculosisNativeItemSegmented = -7,
	
	UItuberculosisNativeItemTextView = -8,
	UItuberculosisNativeItemTextField = -9,
	UItuberculosisNativeItemSearchBar = -10,
	
	UItuberculosisNativeItemPicker = -11,
	UItuberculosisNativeItemDatePicker = -12,
	
	UItuberculosisNativeItemInfoLight = -13,
	UItuberculosisNativeItemInfoDark = -14,
	
	UItuberculosisNativeItemDisclosure = -15,
	
	UItuberculosisNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all tuberculosis instances of
